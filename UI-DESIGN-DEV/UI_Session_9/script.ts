...
function validateName(): void {
    ...
    input.addEventListener("keyup", function (event) {
        if (event.keyCode === 13) {
            var fullName = (<HTMLInputElement>document.getElementById("full_name")).value;
            if (validate(fullName)) {
                document.getElementById("error").style.display = "none";
                document.getElementById("gender-div").style.display = "block";
                document.getElementById("welcome-heading").innerHTML = "Welcome " + (<HTMLInputElement>document.getElementById("full_name")).value;
...
function passwordStrength(pass): Boolean {
...
function validatePassword(): Boolean {
    ...
    let confirm_password = (<HTMLInputElement>document.getElementById("confirm_password")).value;
...
for (i = 6; i < 10; i++) {
    (<HTMLElement>document.getElementsByClassName("form-control")[i]).style.backgroundColor = "#C7EA46";
    (<HTMLElement>document.getElementsByClassName("form-control")[i]).style.borderColor = "green";
}

function submitOrganization():void{
    let organization = (<HTMLInputElement>document.getElementById("organization")).value;
...
function validateVehicleName(): Boolean {
    let vehicle_name = (<HTMLInputElement>document.getElementById("vehicle_name")).value;
    if (vehicle_name.length < 3) {
        ...
        input.addEventListener("keyup", function (event) {
            if (event.keyCode === 13) {
                ...
                document.getElementById("label").innerHTML = "Please let us know the type of " + (<HTMLInputElement>document.getElementById("vehicle_name")).value;
                document.getElementById("vehicle_name").style.display = "none";
            }
        });
    }
}
function submitVehicleType():void{
    let type = (<HTMLInputElement>document.getElementById("typeOfVehicle")).value;
    if (type.match('Select Type')) {
        alert("please select a vehicle type");
    } else {
        document.getElementById("welcome-heading").style.display = "none";
        document.getElementById("vehicleNumber").style.display = "block";
        document.getElementById("label").innerHTML = "Please enter your " + (<HTMLInputElement>document.getElementById("typeOfVehicle")).value + " number";
        ...
        input.addEventListener("keyup", function (event) {
            if (event.keyCode === 13) {
               document.getElementById("vehicleIdentification").style.display = "block";
                document.getElementById("label").innerHTML = "Please describe your " + (<HTMLInputElement>document.getElementById("vehicle_name")).value;
...
let j;
for (j = 10; j < 12; j++) {
    (<HTMLElement>document.getElementsByClassName("form-control")[j]).style.backgroundColor = "#5DB7E6";
    (<HTMLElement>document.getElementsByClassName("form-control")[j]).style.borderColor = "blue";
}
...
function submitCurrencyType():void{
    let type = (<HTMLInputElement>document.getElementById("typeOfCurrency")).value;
    if (type.match('--Select-Type--')) {
    ...
    let table = (<HTMLTableElement>document.getElementById("priceTable"));
    let vehicleType = (<HTMLInputElement>document.getElementById("typeOfVehicle")).value;
    switch (vehicleType) {
        case "Cycle":
    ...
    function convertCurrency(INRPrice) {
        var currencyType = (<HTMLInputElement>document.getElementById("typeOfCurrency")).value;
        if (currencyType == "USD") {
...
function submitPlanType():void{
    let type = (<HTMLInputElement>document.getElementById("planType")).value;
    if (type.match('--Select-Type--')) {
    ...
    document.getElementById("typeOfCurrency").style.display = "none";
    let table = (<HTMLTableElement>document.getElementById("priceTable"));
    let planType = (<HTMLInputElement>document.getElementById("planType")).value;
    switch (planType) {
        case "Daily":
            document.getElementById("label").innerHTML = "Your plan price is " + table.rows[1].cells[1].innerHTML + " " + (<HTMLInputElement>document.getElementById("typeOfCurrency")).value;
            break;
        case "Monthly":
            document.getElementById("label").innerHTML = "Your plan price is " + table.rows[2].cells[1].innerHTML + " " + (<HTMLInputElement>document.getElementById("typeOfCurrency")).value;
            break;
        case "Yearly":
            document.getElementById("label").innerHTML = "Your plan price is " + table.rows[3].cells[1].innerHTML + " " + (<HTMLInputElement>document.getElementById("typeOfCurrency")).value;
            break;
    }
